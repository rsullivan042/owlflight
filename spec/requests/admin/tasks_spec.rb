...
RSpec.describe "Admin::Tasks", type: :request do
  ...
  describe "GET /admin/projects/:project_id/tasks" do
    it "returns 200" do
      get admin_project_tasks_path(project), headers: admin_headers
  ...
  describe "POST /admin/projects/:project_id/tasks" do
    it "creates a task and redirects" do
      ...
      expect(response).to redirect_to(admin_project_tasks_path(project))
    end
  end
